 ...
 * @author Valeria
 */
public class DecimaPreguntaPrueba extends javax.swing.JFrame {
    private Contador contador;
    /**
     * Creates new form decima
     */
    public DecimaPreguntaPrueba() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Has tenido pérdida de apetito en los últimos 30 días? ");
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
        ...
        UndecimaPreguntaPrueba undecimaPreguntaPrueba = new UndecimaPreguntaPrueba();
        undecimaPreguntaPrueba.setVisible(true);
...
//            java.util.logging.Logger.getLogger(DecimaPregunta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new DecimaPregunta().setVisible(true);
//            }
//        });
//    }
