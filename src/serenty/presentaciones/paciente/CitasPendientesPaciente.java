 ...
 * @author User
 */
public class CitasPendientesPaciente extends javax.swing.JInternalFrame {
     ...
     */
    public CitasPendientesPaciente() {
        initComponents();
        MostrarCitas();
    }
    ...
    public void MostrarCitas (){
        ...
        try {
            ...
            ResultSet rsConsultaPaci = psConsultaPaciente.executeQuery();
            rsConsultaPaci.next();
            
            String idPaciente = rsConsultaPaci.getString("ID_PACIENTE");
            
            PreparedStatement psCitas = (PreparedStatement) cn.prepareStatement(String.format(ConsultasDB.SELECT_CITA_IDPACIENTE, idPaciente));
            ...
            while(rsCitas.next()){
                ...
                datos[2] = rsCitas.getString("APELLIDO_PSICOLOGO");
